...
- **New skills** — the shipped skill set is deliberately minimal (`implement-review`, `my-router`). Add your own skills to your fork; the router is designed to be extended.
